...
from src.auth_service.app.auth.schemas import (
    EmailConfirmRequest,
    LoginRequest,
    MessageResponse,
...
from src.auth_service.app.middleware.rate_limiter import (
    login_rate_limit,
...
@router.post(
    "/login",
    response_model=ApiResponse[AuthTokenResponse | TokenResponse],
...
async def login_2fa(
    ...
    tokens = await service.login_2fa(
