...
from src.auth_service.api.responses import ApiResponse, PaginatedData
from src.auth_service.app.admin.schemas import ChangeRoleRequest, AuditLogEntry
from src.auth_service.app.auth.schemas import MessageResponse, UserResponse
